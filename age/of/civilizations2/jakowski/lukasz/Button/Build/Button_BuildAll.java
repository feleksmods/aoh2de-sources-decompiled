...
extends ButtonM {
    ...
    public Button_BuildAll(String sText, int nImageID, int iPosX, int iPosY, int iWidth) {
        this.fontID = CFG.FONT_BOLD_SMALL;
        super.init(CFG.lang.get(sText), 0, iPosX, iPosY, iWidth, CFG.BUTTON_H, true, true, false, false);
