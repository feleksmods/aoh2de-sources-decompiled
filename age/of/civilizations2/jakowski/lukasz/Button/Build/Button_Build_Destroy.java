...
public class Button_Build_Destroy
extends ButtonM {
    public boolean row = false;

    public Button_Build_Destroy(int iPosX, int iPosY, int iWidth, boolean isClickable) {
        super.init("", 0, iPosX, iPosY, iWidth, CFG.BUTTON_H * 4 / 5, isClickable, true, false, false);
    }
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        if (isActive) {
            oSB.setColor(new Color(CFG.COLOR_NEGATIVE_2.r, CFG.COLOR_NEGATIVE_2.g, CFG.COLOR_NEGATIVE_2.b, 0.525f));
        } else if (this.getIsHovered()) {
            oSB.setColor(new Color(CFG.COLOR_NEGATIVE_2.r, CFG.COLOR_NEGATIVE_2.g, CFG.COLOR_NEGATIVE_2.b, 0.725f));
        } else {
            oSB.setColor(new Color(CFG.COLOR_NEGATIVE_2.r, CFG.COLOR_NEGATIVE_2.g, CFG.COLOR_NEGATIVE_2.b, 1.0f));
        }
        IMGManager.getIMG(Images.btnX).drawO(oSB, this.getPosXE() + this.getWidthE() / 2 - (int)((float)IMGManager.getIMG(Images.btnX).getWidth() * Button_Build_Destroy.getImageScale(Images.btnX)) / 2 + iTranslateX, this.getPosY() + this.getHeightE() / 2 - IMGManager.getIMG(Images.btnX).getHeight() - (int)((float)IMGManager.getIMG(Images.btnX).getHeight() * Button_Build_Destroy.getImageScale(Images.btnX)) / 2 + iTranslateY, (int)((float)IMGManager.getIMG(Images.btnX).getWidth() * Button_Build_Destroy.getImageScale(Images.btnX)), (int)((float)IMGManager.getIMG(Images.btnX).getHeight() * Button_Build_Destroy.getImageScale(Images.btnX)));
        oSB.setColor(Color.WHITE);
    }
    ...
    public void buildElemHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Destroy"), CFG.COLOR_NEGATIVE_2));
    ...
    public static final int getButtonWidth() {
        return Math.max((int)((float)IMGManager.getIMG(Images.btnX).getWidth() * Button_Build_Destroy.getImageScale(Images.btnX)) + CFG.PADD * 6, CFG.BUTTON_W / 2);
    }
