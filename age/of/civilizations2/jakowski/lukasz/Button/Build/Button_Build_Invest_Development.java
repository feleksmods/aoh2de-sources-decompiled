...
public class Button_Build_Invest_Development
extends Button_Build {
    ...
    public Button_Build_Invest_Development(String sText, String sProvinceID, int nImageID, int nCost, int nMovementCost, int iPosX, int iPosY, int iWidth) {
        ...
        this.sDate = CFG.lang.get("Development") + ": ";
    ...
    public void drawTextE(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
        ...
        Renderer.drawTextWithShadow(oSB, this.fontID, this.sEconomy, this.getPosXE() + CFG.PADD + ButtonDiplomacy.iDiploWidth + this.iDateWidth + iTranslateX, this.getPosY() + this.getHeightE() / 2 + CFG.PADD / 2 + iTranslateY, CFG.COLOR_NEUTRAL2);
    }
    ...
    public void setMin(int iMin) {
        ...
        try {
            this.sEconomy = "+" + nMin + " [+" + CFG.getPercentage_Max100_X100(nMin, CFG.core.getProv(Menu_InGame_Invest_Development.iProvinceID).getDeveLvl(), 4) + "%]";
        }
