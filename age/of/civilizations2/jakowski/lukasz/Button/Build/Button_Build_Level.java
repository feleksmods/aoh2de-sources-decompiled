...
public class Button_Build_Level
extends Button_Build {
    private String sLevelID;
    private String sLevel;
    private int iLevelWidth = 0;

    public Button_Build_Level(String sText, int nImageID, String nLevelID, int nCost, int nMovementCost, int iPosX, int iPosY, int iWidth, boolean isClickable, boolean isBuildMax, int inConstruction, float fTech) {
