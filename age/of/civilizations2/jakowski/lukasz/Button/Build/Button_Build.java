...
extends ButtonM {
    ...
    public Button_Build(String sText, int nImageID, int nCost, int nMovementCost, int iPosX, int iPosY, int iWidth, boolean isClickable, boolean isBuildMax, int inConstruction, float fTech) {
        ...
        if (this.checkbox) {
            return new ButtonM.Checkbox(){
                ...
                public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
                    if (Button_Build.this.getCheckboxSt()) {
                        oSB.setColor(new Color(CFG.COLOR_POSITIVE_BUILT.r, CFG.COLOR_POSITIVE_BUILT.g, CFG.COLOR_POSITIVE_BUILT.b, 0.2f));
                        IMGManager.getIMG(Images.patternSquareTiny).draw2O(oSB, Button_Build.this.getPosXE() + iTranslateX, Button_Build.this.getPosY() - IMGManager.getIMG(Images.patternSquareTiny).getHeight() + 1 + iTranslateY, ButtonDiplomacy.iDiploWidth, Button_Build.this.getHeightE() - 2, true, false);
                        oSB.setColor(new Color(0.0f, 0.0f, 0.0f, 0.3f));
                        IMGManager.getIMG(Images.gradient).drawO(oSB, Button_Build.this.getPosXE() + iTranslateX, Button_Build.this.getPosY() - IMGManager.getIMG(Images.gradient).getHeight() + 1 + iTranslateY, ButtonDiplomacy.iDiploWidth, Button_Build.this.getHeightE() / 4, false, false);
                        IMGManager.getIMG(Images.gradient).drawO(oSB, Button_Build.this.getPosXE() + iTranslateX, Button_Build.this.getPosY() - IMGManager.getIMG(Images.gradient).getHeight() + Button_Build.this.getHeightE() - 1 + iTranslateY - Button_Build.this.getHeightE() / 4, ButtonDiplomacy.iDiploWidth, Button_Build.this.getHeightE() / 4, false, true);
