...
public class Button_Build_Decrees
extends Button_Build {
    ...
    public Button_Build_Decrees(String sText, int nImageID, int nCost, int nMovementCost, int iPosX, int iPosY, int iWidth, boolean isClickable, boolean isBuildMax, int inConstruction, float fTech, String textL, String textR, int iconIMG, Color colorRight) {
