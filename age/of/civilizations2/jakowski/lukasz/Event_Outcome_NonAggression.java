...
extends Event_Outcome {
    ...
    public void outcomeAction() {
        if (this.canMakeAction()) {
            CFG.core.setCivNonAggressionPact(this.getCivID(), this.getCivID2(), this.getValue());
    ...
    public List<MEHover_2E> getHoverText() {
        try {
            ...
            if (this.canMakeAction()) {
                ...
                tData.add(new ME_Hover_2Type_Text(GameCalendar.getDate_ByTurnID(GameCalendar.TURNID + this.getValue()), CFG.COLOR_NEUTRAL2));
