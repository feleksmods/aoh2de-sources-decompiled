...
extends Menu {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(2).setTextE(CFG.lang.get("AdministrationPolicy") + ": " + CFG.lang.get(GameValues.gvAdministrationPolicy.POLICY_NAME[CFG.eventsManager.createScenarioEvents.lDecisions.get((int)CFG.eventsManager.createEvent_EditTriggerID).lOutcomes.get(CFG.eventsManager.createEvent_EditConditionID).getValue()]));
        }
        catch (Exception ex) {
