...
extends Menu {
    ...
    public Menu_InGame_Message_Gift(int onCivID, int iMessageID, int iValue) {
        ...
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        menuElements.add(new Button_Diplomacy_Message_Gift(CFG.lang.get("AGiftFromCivA", CFG.core.getCiv(this.iOnCivID).getCivName()), this.iOnCivID, "" + iValue, 2, tY, CFG.BUTTON_W * 2){
