...
public class Menu_InGame_PlunderAllArmies
extends Menu {
    public final int getElementW2() {
        return this.getWidthM();
    }

    public Menu_InGame_PlunderAllArmies() {
        ...
        menuElements.add(new ButtonN_Pop(new Color((float)CFG.core.getCiv(iCivID).getR() / 255.0f, (float)CFG.core.getCiv(iCivID).getG() / 255.0f, (float)CFG.core.getCiv(iCivID).getB() / 255.0f, 1.0f), CFG.core.getCiv(iCivID).getCivName(), iCivID, CFG.lang.get("Army") + ": ", CFG.getNumberWthSpaces("" + CFG.core.getCiv(iCivID).getNumberOfUnits()), Images.diploArmy, CFG.COLOR_TEXT_NUM_OF_PROVINCES, 0, tY, tempWidth){
            ...
            public int getWidthE() {
                return Menu_InGame_PlunderAllArmies.this.getElementW2();
            }
        });
        menuElements.add(new Text_Desc(CFG.lang.get("PlunderSelectedArmiesDesc"), CFG.PADD, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, tempWidth - CFG.PADD * 2){

            @Override
            public int getWidthE() {
                return Menu_InGame_PlunderAllArmies.this.getElementW2() - CFG.PADD * 2;
            }
        });
        menuElements.add(new Text_Desc(CFG.lang.get("OnlyOccupiedProvinceCanBePlundered"), CFG.PADD, tY += ((MenuElemUI)menuElements.get(menuElements.size() - 1)).getHeightE() + CFG.PADD, tempWidth - CFG.PADD * 2){
        ...
        menuElements.add(new Button_InGameAction(CFG.lang.get("Close"), -1, 2 + CFG.PADD, tY += CFG.PADD, CFG.BUTTON_W, true){
            ...
            @Override
            public int getWidthE() {
                return Menu_InGame_PlunderAllArmies.this.getElementW() - CFG.PADD - CFG.PADD / 2;
            }
        });
        menuElements.add(new Button_InGameAction(CFG.lang.get("Confirm"), -1, 2, tY, CFG.BUTTON_W, true){
            ...
            @Override
            public int getPosXE() {
                return Menu_InGame_PlunderAllArmies.this.getElementW() + CFG.PADD / 2;
            }
            ...
            public void buildElemHover() {
                ...
                nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("PlunderSelectedArmies"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
        ...
        this.initMenu(new TitleM_TextSmall(CFG.lang.get("PlunderSelectedArmies"), CFG.BUTTON_H * 3 / 4, true, true){
            ...
            public void drawT(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                oSB.setColor(new Color(0.65882355f, 0.41960785f, 0.18431373f, 0.165f));
                IMGManager.getIMG(Images.line32Off1).drawO(oSB, nPosX + iTranslateX, nPosY - this.getHeightT() + 2 - IMGManager.getIMG(Images.line32Off1).getHeight(), nWidth, this.getHeightT() - 2, false, true);
                oSB.setColor(new Color(0.65882355f, 0.41960785f, 0.18431373f, 0.375f));
