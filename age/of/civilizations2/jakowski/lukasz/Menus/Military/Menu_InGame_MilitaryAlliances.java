        ...
        try {
            ...
            if (sortBy == 0) {
                ...
                while (tempIDs.size() > 0) {
                    tAdd = 0;
                    for (i = 1; i < tempIDs.size(); ++i) {
                        if (!CFG.compareAlphabetic_TwoString(CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(tAdd)).getCivilization(0)).getCapitalProvID()).getCitiesSize() > 0 ? CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(tAdd)).getCivilization(0)).getCapitalProvID()).getCit(0).getCityName() : (CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(tAdd)).getCivilization(0)).getCapitalProvID()).getName().length() > 0 ? CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(tAdd)).getCivilization(0)).getCapitalProvID()).getName() : CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(tAdd)).getCivilization(0)).getCivName()), CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(i)).getCivilization(0)).getCapitalProvID()).getCitiesSize() > 0 ? CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(i)).getCivilization(0)).getCapitalProvID()).getCit(0).getCityName() : (CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(i)).getCivilization(0)).getCapitalProvID()).getName().length() > 0 ? CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(i)).getCivilization(0)).getCapitalProvID()).getName() : CFG.core.getCiv(CFG.core.getAlliance((Integer)tempIDs.get(i)).getCivilization(0)).getCivName()))) continue;
                        tAdd = i;
                    }
                    this.lSorted.add((Integer)tempIDs.get(tAdd));
                    tempIDs.remove(tAdd);
            ...
            for (i2 = 0; i2 < this.lSorted.size(); ++i2) {
                ...
                menuElements.add(new Button_Stats_Flag_Clip(CFG.FOG_OF_WAR == 2 ? (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)) ? CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0) : -1) : CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0), CFG.FOG_OF_WAR == 2 ? (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetProv(CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCapitalProvID()) ? (CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCapitalProvID()).getCitiesSize() > 0 ? CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCapitalProvID()).getCit(0).getCityName() : (CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCapitalProvID()).getName().length() > 0 ? CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCapitalProvID()).getName() : CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCivName())) : CFG.lang.get("Undiscovered")) : (CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCapitalProvID()).getCitiesSize() > 0 ? CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCapitalProvID()).getCit(0).getCityName() : (CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCapitalProvID()).getName().length() > 0 ? CFG.core.getProv(CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCapitalProvID()).getName() : CFG.core.getCiv(CFG.core.getAlliance(this.lSorted.get(i2)).getCivilization(0)).getCivName())), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 2, tPosY, CFG.BUTTON_W, tElemHeight2){
