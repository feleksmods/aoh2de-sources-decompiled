...
extends Menu {
    ...
    public static int armyToSend = 0;
    ...
    public Menu_InGame_SendArmy(int nFromProvinceID) {
        ...
        int maxArmy = CFG.core.getProv(fromProvinceID).getArmyCivID1(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId());
        if (maxArmy <= 0) {
            fromProvinceID = -1;
        }
    ...
    public void sendArmy() {
        if (toProvinceID < 0) {
            ...
            int army = Math.min(armyToSend, CFG.core.getProv(fromProvinceID).getArmyCivID1(CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId()));
