...
extends Menu {
    ...
    public final void actionEL(int iID) {
        if (iID == this.getMenuElemsSize() - 1) {
            ...
            GameManager.sendGift(this.iOnCivID, CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId(), this.getMenuElem(this.getMenuElemsSize() - 3).getCurr());
