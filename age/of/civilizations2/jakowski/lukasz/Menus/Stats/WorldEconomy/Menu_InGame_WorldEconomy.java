...
extends Menu {
    ...
    public Menu_InGame_WorldEconomy() {
        ...
        for (i4 = 0; i4 < CFG.map.getMapContinents().getContinentsSize(); ++i4) {
            ...
            tProvinces.add(0);
            tLargestCity.add(-1);
            tMostEconomy2.add(new ArrayList());
        ...
        menuElements.add(new Button_Stats_Flag_Clip_ProvinceID(CFG.FOG_OF_WAR == 2 ? (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetProv(tLargestCityTotal) ? tLargestCityTotal : -1) : tLargestCityTotal, CFG.FOG_OF_WAR == 2 ? (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetProv(tLargestCityTotal) ? (CFG.core.getProv(tLargestCityTotal).getCitiesSize() > 0 ? CFG.core.getProv(tLargestCityTotal).getCit(0).getCityName() : (CFG.core.getProv(tLargestCityTotal).getName().length() > 0 ? CFG.core.getProv(tLargestCityTotal).getName() : CFG.lang.get("NoData"))) : CFG.lang.get("Undiscovered")) : (CFG.core.getProv(tLargestCityTotal).getCitiesSize() > 0 ? CFG.core.getProv(tLargestCityTotal).getCit(0).getCityName() : (CFG.core.getProv(tLargestCityTotal).getName().length() > 0 ? CFG.core.getProv(tLargestCityTotal).getName() : CFG.lang.get("NoData"))), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 5, tPosY, CFG.BUTTON_W, tElemHeight2){
        ...
        for (i2 = 0; i2 < tSorted.size(); ++i2) {
            ...
            menuElements.add(new Button_Stats_Flag_Clip_ProvinceID(CFG.FOG_OF_WAR == 2 ? (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))) ? (Integer)tLargestCity.get((Integer)tSorted.get(i2)) : -1) : (Integer)tLargestCity.get((Integer)tSorted.get(i2)), CFG.FOG_OF_WAR == 2 ? (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getMetProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))) ? (CFG.core.getProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))).getCitiesSize() > 0 ? CFG.core.getProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))).getCit(0).getCityName() : (CFG.core.getProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))).getName().length() > 0 ? CFG.core.getProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))).getName() : CFG.lang.get("NoData"))) : CFG.lang.get("Undiscovered")) : (CFG.core.getProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))).getCitiesSize() > 0 ? CFG.core.getProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))).getCit(0).getCityName() : (CFG.core.getProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))).getName().length() > 0 ? CFG.core.getProv((Integer)tLargestCity.get((Integer)tSorted.get(i2))).getName() : CFG.lang.get("NoData"))), CFG.PADD, CFG.PADD * 2 + CFG.BUTTON_W * 5, tPosY, CFG.BUTTON_W, tElemHeight2){
