...
extends Menu {
    ...
    public void updateLang() {
        ...
        try {
            this.getMenuElem(5).setTextE(CFG.lang.get("AdministrationPolicy") + " == " + CFG.lang.get(GameValues.gvAdministrationPolicy.POLICY_NAME[CFG.eventsManager.createScenarioEvents.getTrigger((int)CFG.eventsManager.createEvent_EditTriggerID).lConditions.get(CFG.eventsManager.createEvent_EditConditionID).getValue()]));
        }
        catch (Exception ex) {
