...
public class Menu_Settings_Language
extends Menu {
    ...
    public void updateLang() {
        ...
        this.getMenuElem(1).setTextE("EN");
        this.getMenuElem(2).setTextE("DE");
        this.getMenuElem(3).setTextE("PL");
        this.getTitleM().setText(CFG.lang.get("SelectLanguage"));
    }
