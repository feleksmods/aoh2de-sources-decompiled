...
public class Menu_InGame_CreateAVassal_Gov
extends Menu {
    public Menu_InGame_CreateAVassal_Gov() {
        ...
        menuElements.add(new Button_InGameAction(CFG.lang.get("Close"), -1, 2, tY += CFG.PADD, CFG.BUTTON_W, true){
            ...
            public int getWidthE() {
                return Menu_InGame_CreateAVassal_Gov.this.getW();
            }

            @Override
            public void actionElem(int iID) {
                Menu_InGame_CreateAVassal_Gov.this.setVisibleM(false);
            }
        });
