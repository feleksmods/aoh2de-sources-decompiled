...
extends Message {
    ...
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_PrepareForWar(this.fromCivID, iMessageID, this.iValue, this.iValue2 - GameCalendar.TURNID);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.acceptPrepareForWar(this.iLeaderCivID, iCivID, this.fromCivID, this.iValue, this.iValue2 - GameCalendar.TURNID);
    }

    @Override
    public void onDecline(int iCivID) {
        GameManager.declinePrepareForWar(this.iLeaderCivID, iCivID, this.fromCivID, this.iValue, this.iValue2 - GameCalendar.TURNID);
    }
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text(CFG.core.getCiv(this.iValue).getCivName(), CFG.COLOR_HOVER_TITLE));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("PreparationTime") + ": "));
        nData.add(new ME_Hover_2Type_Text(CFG.lang.get("TurnsX", this.iValue2 - GameCalendar.TURNID), CFG.COLOR_HOVER_TITLE));
