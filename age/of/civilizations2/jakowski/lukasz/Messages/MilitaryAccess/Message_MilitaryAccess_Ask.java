...
extends Message {
    ...
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_MilitaryAccess_Ask(this.fromCivID, iMessageID, this.iValue);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.acceptMilitaryAccess_Ask(iCivID, this.fromCivID, this.iValue);
    }

    @Override
    public void onDecline(int iCivID) {
        GameManager.declineMilitaryAccess_Ask(iCivID, this.fromCivID, this.iValue);
    }
