...
extends Message {
    ...
    public void onAccept(int iCivID) {
        if (CFG.core.getPlayer(CFG.PLAYER_TURN_ID).getCivId() == iCivID) {
            ...
            lMess.add(CFG.lang.get("MilitaryAccessWillExpireInNextXTurnsTo", this.iValue) + ": " + CFG.core.getCiv(this.fromCivID).getCivName());
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("MilitaryAccessWillExpireInNextXTurnsTo", this.iValue) + ": ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
