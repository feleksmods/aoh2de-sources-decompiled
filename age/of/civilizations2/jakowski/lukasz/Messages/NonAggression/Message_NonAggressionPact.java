...
extends Message {
    ...
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_NonAggression(this.fromCivID, iMessageID, this.iValue);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.acceptNonAggressionPact(iCivID, this.fromCivID, this.iValue);
    }

    @Override
    public void onDecline(int iCivID) {
        GameManager.declineNonAggressionPact(iCivID, this.fromCivID, this.iValue);
    }
