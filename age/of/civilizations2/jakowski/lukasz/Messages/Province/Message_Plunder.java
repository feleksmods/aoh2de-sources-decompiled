...
extends Message {
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text_Big(CFG.lang.get("Plunder") + (CFG.core.getProv(this.iValue).getName().length() > 0 ? ": " + CFG.core.getProv(this.iValue).getName() : ""), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
