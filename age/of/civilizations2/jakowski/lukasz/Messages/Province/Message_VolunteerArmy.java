...
public class Message_VolunteerArmy
extends Message {
    public Message_VolunteerArmy(int fromCivID, int iValue, int toProvinceID) {
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text(CFG.core.getProv(this.iValue2).getProvName(), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
