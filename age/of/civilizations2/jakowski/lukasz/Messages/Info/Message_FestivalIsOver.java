...
extends Message {
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Text("" + (int)(CFG.core.getProv(this.iValue).getHappi() * 100.0f) + "%", CFG.COLOR_HAPPINESS_MAX));
        nData.add(new ME_Hover_2Type_Image(CFG.getHappinessImage((int)(CFG.core.getProv(this.iValue).getHappi() * 100.0f)), CFG.PADD, 0));
        nElements.add(new MEHover_2E(nData));
        nData.clear();
        nData.add(new ME_Hover_2Type_Space());
        nElements.add(new MEHover_2E(nData));
