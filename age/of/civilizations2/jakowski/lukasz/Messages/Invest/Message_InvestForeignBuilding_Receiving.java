...
extends Message {
    ...
    public Message_InvestForeignBuilding_Receiving(int fromCivID, int iValue, int gold, int profit) {
    ...
    public ME_Hover_v2 getHover() {
        ...
        nData.add(new ME_Hover_2Type_Flag_Big(CFG.core.getProv(this.iValue).getCivId()));
