...
extends Message {
    ...
    public void onAction(int iMessageID) {
        CFG.menus.rebuildInGame_Message_OfferVasalization(this.fromCivID, iMessageID, this.iValue);
    }

    @Override
    public void onAccept(int iCivID) {
        GameManager.acceptOfferVassalization(iCivID, this.fromCivID, this.iValue);
    }

    @Override
    public void onDecline(int iCivID) {
        GameManager.declineOfferVassalization(iCivID, this.fromCivID, this.iValue);
    }
