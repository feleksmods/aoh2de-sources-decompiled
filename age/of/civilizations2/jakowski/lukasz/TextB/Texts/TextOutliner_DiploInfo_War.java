...
extends Text {
    ...
    public void actionElem(int iID) {
        CFG.toastM.addM((this.iCivLeft >= 0 ? CFG.core.getCiv(this.iCivLeft).getCivName() : CFG.lang.get("Undiscovered")) + " vs " + (this.iCivRight >= 0 ? CFG.core.getCiv(this.iCivRight).getCivName() : CFG.lang.get("Undiscovered")), CFG.COLOR_NEGATIVE_2);
